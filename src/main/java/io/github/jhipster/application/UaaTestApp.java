...
import io.github.jhipster.application.client.OAuth2InterceptedFeignConfiguration;
...
public class UaaTestApp {

    private static final Logger log = LoggerFactory.getLogger(UaaTestApp.class);

    private final Environment env;

    public UaaTestApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(UaaTestApp.class);
